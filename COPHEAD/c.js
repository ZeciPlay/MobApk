...
style.textContent = `
@keyframes glow {
    0% { box-shadow: 0 0 5px #ff4d4d, 0 0 10px #ff4d4d, 0 0 15px #4077ff; }
    50% { box-shadow: 0 0 20px #ff3333, 0 0 30px #ff3333, 0 0 40px #4077ff; }
    100% { box-shadow: 0 0 5px #ff4d4d, 0 0 10px #ff4d4d, 0 0 15px #4077ff; }
}

.button-glow {
    animation: glow 2s ease-in-out infinite;
    background-color: #4077ff; /* Cor */
    border: 2px solid #4077ff; /* Borda escura */
